  ...
  describe "declaresEntryPoint" $ do
    describe "with program declarations" $ do
      ...
      it "is False when program is not declared" $ do
        ...
        declaresEntryPoint anyone (gbs code) `shouldBe` False
  ...
  describe "hasDuplicateCode" $ do
    describe "with bodys Exactly equals" $ do
      it "is True when two empty procedures are equals" $ do
        --  code = "procedure F(){} procedure G(){}"
        let code = "[\r\n  {\r\n    \"value\": \"F\",\r\n    \"arity\": \"routine\",\r\n    \"reserved\": false,\r\n    \"led\": null,\r\n    \"lbp\": 0,\r\n    \"name\": \"F\",\r\n    \"alias\": \"procedureDeclaration\",\r\n    \"parameters\": [],\r\n    \"body\": null\r\n  },\r\n  {\r\n    \"value\": \"G\",\r\n    \"arity\": \"routine\",\r\n    \"reserved\": false,\r\n    \"led\": null,\r\n    \"lbp\": 0,\r\n    \"name\": \"G\",\r\n    \"alias\": \"procedureDeclaration\",\r\n    \"parameters\": [],\r\n    \"body\": null\r\n  }\r\n]"
        hasDuplicateCode (gbs code) `shouldBe` True

      it "is False when two procedures are not equals" $ do
        --  code = "procedure F(){} procedure G(){Sacar(Verde)}"
        let code = "[\r\n  {\r\n    \"value\": \"F\",\r\n    \"arity\": \"routine\",\r\n    \"reserved\": false,\r\n    \"led\": null,\r\n    \"lbp\": 0,\r\n    \"name\": \"F\",\r\n    \"alias\": \"procedureDeclaration\",\r\n    \"parameters\": [],\r\n    \"body\": null\r\n  },\r\n  {\r\n    \"value\": \"G\",\r\n    \"arity\": \"routine\",\r\n    \"reserved\": false,\r\n    \"led\": null,\r\n    \"lbp\": 0,\r\n    \"name\": \"G\",\r\n    \"alias\": \"procedureDeclaration\",\r\n    \"parameters\": [],\r\n    \"body\": [\r\n      {\r\n        \"alias\": \"RemoveStone\",\r\n        \"parameters\": [\r\n          {\r\n            \"value\": 3,\r\n            \"arity\": \"literal\",\r\n            \"reserved\": true\r\n          }\r\n        ]\r\n      }\r\n    ]\r\n  }\r\n]"
        hasDuplicateCode (gbs code) `shouldBe` False

      it "is True when two functions are equals" $ do
        --  code = "function f(){if(True){}else{} return (x)} function g(){if(True){}else{} return (x)}"
        let code = "[\r\n  {\r\n    \"value\": \"f\",\r\n    \"arity\": \"routine\",\r\n    \"reserved\": false,\r\n    \"led\": null,\r\n    \"lbp\": 0,\r\n    \"name\": \"f\",\r\n    \"alias\": \"functionDeclaration\",\r\n    \"parameters\": [],\r\n    \"body\": [\r\n      {\r\n        \"alias\": \"conditional\",\r\n        \"condition\": {\r\n          \"value\": true,\r\n          \"arity\": \"literal\",\r\n          \"reserved\": true\r\n        },\r\n        \"left\": null,\r\n        \"right\": null\r\n      }\r\n    ],\r\n    \"return\": {\r\n      \"value\": \"x\",\r\n      \"arity\": \"name\"\r\n    }\r\n  },\r\n  {\r\n    \"value\": \"g\",\r\n    \"arity\": \"routine\",\r\n    \"reserved\": false,\r\n    \"led\": null,\r\n    \"lbp\": 0,\r\n    \"name\": \"g\",\r\n    \"alias\": \"functionDeclaration\",\r\n    \"parameters\": [],\r\n    \"body\": [\r\n      {\r\n        \"alias\": \"conditional\",\r\n        \"condition\": {\r\n          \"value\": true,\r\n          \"arity\": \"literal\"\r\n        },\r\n        \"left\": null,\r\n        \"right\": null\r\n      }\r\n    ],\r\n    \"return\": {\r\n      \"value\": \"x\",\r\n      \"arity\": \"name\"\r\n    }\r\n  }\r\n]"
        hasDuplicateCode (gbs code) `shouldBe` True

      it "is True when a function and a procedure have same body" $ do
        --  code = "procedure G(){if(True){}else{} } function f(){if(True){}else{} return (x)}"
        let code = "[\r\n  {\r\n    \"value\": \"G\",\r\n    \"arity\": \"routine\",\r\n    \"reserved\": false,\r\n    \"led\": null,\r\n    \"lbp\": 0,\r\n    \"name\": \"G\",\r\n    \"alias\": \"procedureDeclaration\",\r\n    \"parameters\": [],\r\n    \"body\": [\r\n      {\r\n        \"alias\": \"conditional\",\r\n        \"condition\": {\r\n          \"value\": true,\r\n          \"arity\": \"literal\",\r\n          \"reserved\": true\r\n        },\r\n        \"left\": null,\r\n        \"right\": null\r\n      }\r\n    ]\r\n  },\r\n  {\r\n    \"value\": \"f\",\r\n    \"arity\": \"routine\",\r\n    \"reserved\": false,\r\n    \"led\": null,\r\n    \"lbp\": 0,\r\n    \"name\": \"f\",\r\n    \"alias\": \"functionDeclaration\",\r\n    \"parameters\": [],\r\n    \"body\": [\r\n      {\r\n        \"alias\": \"conditional\",\r\n        \"condition\": {\r\n          \"value\": true,\r\n          \"arity\": \"literal\"\r\n        },\r\n        \"left\": null,\r\n        \"right\": null\r\n      }\r\n    ],\r\n    \"return\": {\r\n      \"value\": \"x\",\r\n      \"arity\": \"name\"\r\n    }\r\n  }\r\n]"
        hasDuplicateCode (gbs code) `shouldBe` True

      it "is True when two functions have same body" $ do
        --  code = "function f(){ Sacar(Verde) return (2) } function g(){ Sacar(Verde) return (2) }"
        let code = "[\r\n  {\r\n    \"value\": \"f\",\r\n    \"arity\": \"routine\",\r\n    \"reserved\": false,\r\n    \"led\": null,\r\n    \"lbp\": 0,\r\n    \"name\": \"f\",\r\n    \"alias\": \"functionDeclaration\",\r\n    \"parameters\": [],\r\n    \"body\": [\r\n      {\r\n        \"alias\": \"RemoveStone\",\r\n        \"parameters\": [\r\n          {\r\n            \"value\": 3,\r\n            \"arity\": \"literal\",\r\n            \"reserved\": true\r\n          }\r\n        ]\r\n      }\r\n    ],\r\n    \"return\": {\r\n      \"value\": 2,\r\n      \"arity\": \"literal\"\r\n    }\r\n  },\r\n  {\r\n    \"value\": \"g\",\r\n    \"arity\": \"routine\",\r\n    \"reserved\": false,\r\n    \"led\": null,\r\n    \"lbp\": 0,\r\n    \"name\": \"g\",\r\n    \"alias\": \"functionDeclaration\",\r\n    \"parameters\": [],\r\n    \"body\": [\r\n      {\r\n        \"alias\": \"RemoveStone\",\r\n        \"parameters\": [\r\n          {\r\n            \"value\": 3,\r\n            \"arity\": \"literal\"\r\n          }\r\n        ]\r\n      }\r\n    ],\r\n    \"return\": {\r\n      \"value\": 2,\r\n      \"arity\": \"literal\"\r\n    }\r\n  }\r\n]"
        hasDuplicateCode (gbs code) `shouldBe` True

      it "is True when two functions have same return" $ do
        --  code = "function f(){ Sacar(Verde) return (2) } function g(){return (2) }"
        let code = "[\r\n  {\r\n    \"value\": \"f\",\r\n    \"arity\": \"routine\",\r\n    \"reserved\": false,\r\n    \"led\": null,\r\n    \"lbp\": 0,\r\n    \"name\": \"f\",\r\n    \"alias\": \"functionDeclaration\",\r\n    \"parameters\": [],\r\n    \"body\": [\r\n      {\r\n        \"alias\": \"RemoveStone\",\r\n        \"parameters\": [\r\n          {\r\n            \"value\": 3,\r\n            \"arity\": \"literal\",\r\n            \"reserved\": true\r\n          }\r\n        ]\r\n      }\r\n    ],\r\n    \"return\": {\r\n      \"value\": 2,\r\n      \"arity\": \"literal\"\r\n    }\r\n  },\r\n  {\r\n    \"value\": \"g\",\r\n    \"arity\": \"routine\",\r\n    \"reserved\": false,\r\n    \"led\": null,\r\n    \"lbp\": 0,\r\n    \"name\": \"g\",\r\n    \"alias\": \"functionDeclaration\",\r\n    \"parameters\": [],\r\n    \"body\": [],\r\n    \"return\": {\r\n      \"value\": 2,\r\n      \"arity\": \"literal\"\r\n    }\r\n  }\r\n]"
        hasDuplicateCode (gbs code) `shouldBe` True

      it "is True when two functions have not same return" $ do
        --  code = "function f(){ Sacar(Verde) return (2) } function g(){return (3) }"
        let code = "[\r\n  {\r\n    \"value\": \"f\",\r\n    \"arity\": \"routine\",\r\n    \"reserved\": false,\r\n    \"led\": null,\r\n    \"lbp\": 0,\r\n    \"name\": \"f\",\r\n    \"alias\": \"functionDeclaration\",\r\n    \"parameters\": [],\r\n    \"body\": [\r\n      {\r\n        \"alias\": \"RemoveStone\",\r\n        \"parameters\": [\r\n          {\r\n            \"value\": 3,\r\n            \"arity\": \"literal\",\r\n            \"reserved\": true\r\n          }\r\n        ]\r\n      }\r\n    ],\r\n    \"return\": {\r\n      \"value\": 2,\r\n      \"arity\": \"literal\"\r\n    }\r\n  },\r\n  {\r\n    \"value\": \"g\",\r\n    \"arity\": \"routine\",\r\n    \"reserved\": false,\r\n    \"led\": null,\r\n    \"lbp\": 0,\r\n    \"name\": \"g\",\r\n    \"alias\": \"functionDeclaration\",\r\n    \"parameters\": [],\r\n    \"body\": [],\r\n    \"return\": {\r\n      \"value\": 3,\r\n      \"arity\": \"literal\"\r\n    }\r\n  }\r\n]"
        hasDuplicateCode (gbs code) `shouldBe` False

      it "is True when two functions have same expressions" $ do
        --  code = "function f(){ Sacar(Verde) return (x == y) } function g(){ while(x==y){} return (2) }"
        let code = "[\r\n  {\r\n    \"value\": \"f\",\r\n    \"arity\": \"routine\",\r\n    \"reserved\": false,\r\n    \"led\": null,\r\n    \"lbp\": 0,\r\n    \"name\": \"f\",\r\n    \"alias\": \"functionDeclaration\",\r\n    \"parameters\": [],\r\n    \"body\": [\r\n      {\r\n        \"alias\": \"RemoveStone\",\r\n        \"parameters\": [\r\n          {\r\n            \"value\": 3,\r\n            \"arity\": \"literal\",\r\n            \"reserved\": true\r\n          }\r\n        ]\r\n      }\r\n    ],\r\n    \"return\": {\r\n      \"value\": \"==\",\r\n      \"arity\": \"binary\",\r\n      \"left\": {\r\n        \"value\": \"x\",\r\n        \"arity\": \"name\"\r\n      },\r\n      \"right\": {\r\n        \"value\": \"y\",\r\n        \"arity\": \"name\"\r\n      }\r\n    }\r\n  },\r\n  {\r\n    \"value\": \"g\",\r\n    \"arity\": \"routine\",\r\n    \"reserved\": false,\r\n    \"led\": null,\r\n    \"lbp\": 0,\r\n    \"name\": \"g\",\r\n    \"alias\": \"functionDeclaration\",\r\n    \"parameters\": [],\r\n    \"body\": [\r\n      {\r\n        \"alias\": \"while\",\r\n        \"expression\": {\r\n          \"value\": \"==\",\r\n          \"arity\": \"binary\",\r\n          \"left\": {\r\n            \"value\": \"x\",\r\n            \"arity\": \"name\"\r\n          },\r\n          \"right\": {\r\n            \"value\": \"y\",\r\n            \"arity\": \"name\"\r\n          }\r\n        },\r\n        \"body\": null\r\n      }\r\n    ],\r\n    \"return\": {\r\n      \"value\": 2,\r\n      \"arity\": \"literal\"\r\n    }\r\n  }\r\n]"
        hasDuplicateCode (gbs code) `shouldBe` True
