...
import Language.Mulang.Ast hiding (And, Or, Primitive, While, Return, Equal, Lambda, Try, Switch, Assert)
...
muOp Mult   = M.Primitive M.Multiply
muOp Div    = M.Primitive M.Divide
muOp Rem    = Reference "rem"
muOp Add    = M.Primitive M.Plus
muOp Sub    = M.Primitive M.Minus
