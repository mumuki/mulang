...
normalize (InstanceMethod n equations)     = InstanceMethod n (map normalizeEquation equations)
normalize (ClassMethod n equations)        = ClassMethod n (map normalizeEquation equations)
...
normalizeInObject (Function n eqs)             = InstanceMethod n (map normalizeEquation eqs)
normalizeInObject (Variable n (Lambda vars e)) = SimpleInstanceMethod n vars (normalize e)
