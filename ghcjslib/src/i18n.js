(() => {
  ...
  const LOCALES = {
    es: {
      ...
      HasDeclarationTypos_named: (binding, must, target, keyword) => `La solución debe declarar ${target}, pero declara ${binding}. ¿Puede que hayas cometido un error de tipeo?`,
      ...
      HasUsageTypos_named: (binding, must, target, keyword) => `La solución debe usar ${target}, pero usa ${binding}. ¿Puede que hayas cometido un error de tipeo?`,
