(() => {
  ...
  const LOCALES = {
    es: {
      ...
      ShouldInvertIfCondition: (binding, must, target, keyword) => `${binding} debería invertir la condición del <i>${keyword_if}</i> e intercambiar las ramas`,
    ...
    en: {
      ...
      HasRedundantReduction: (binding, must, target, keyword) => `${binding} uses <i>${keyword_is}</i>, but it does no arithmetics`,
      HasRedundantRepeat: (binding, must, target, keyword) => `${binding} has an unnecessary <i>${keyword_repeat}</i>`,
      ...
      ShouldInvertIfCondition: (binding, must, target, keyword) => `${binding} should invert <i>${keyword_if}</i> condition and swap branches`,
    ...
    pt: {
      ...
      ShouldInvertIfCondition: (binding, must, target, keyword) => `${binding} deve inverter a condição da <i>${keyword_if}</i> e trocar as ramos`,
