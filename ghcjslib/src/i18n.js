(() => {
  ...
  const LOCALES = {
    es: {
      ...
      DeclaresComputationWithArity0_named: (binding, must, target, keyword) => `${target} ${must} tener cero parametros`,
      ...
      DeclaresFunction: (binding, must, target, keyword) => `${binding} ${must} declarar funciones`,
      ...
      DeclaresPredicate_named: (binding, must, target, keyword) => `${binding} ${must} declarar un predicado ${target}`,
      ...
      DeclaresRule: (binding, must, target, keyword) => `${binding} ${must} declarar reglas`,
      ...
      DoesNilTest: (binding, must, target, keyword) => `${binding} hace comparaciones contra <code>${keyword['null']}</code>`,
      DoesNullTest: (binding, must, target, keyword) => `${binding} hace comparaciones contra <code>${keyword['null']}</code>`,
      DoesTypeTest: (binding, must, target, keyword) => `${binding} hace comparaciones contra strings`,
      HasAssignmentCondition: (binding, must, target, keyword) => `${binding} evalúa el resultado de una asignación en donde se esperaba una expresión booleana. ¿Quizás quisiste usar el operador <code>${keyword['equal']}</code>?`,
      HasAssignmentReturn: (binding, must, target, keyword) => `${binding} devuelve el resultado de una asignación. ¿Quizás quisiste usar el operador <code>${keyword['equal']}</code>?`,
      HasCodeDuplication: (binding, must, target, keyword) => `${binding} tiene código repetido`,
      HasDeclarationTypos_named: (binding, must, target, keyword) => `La solución parece tener un error de tipeo: debe declarar ${target}, pero declara ${binding}. ¿Quizás quisiste decir ${target}?`,
      HasEmptyIfBranches: (binding, must, target, keyword) => `${binding} tiene ramas de <code>${keyword['if']}</code> vacías`,
      HasEmptyRepeat: (binding, must, target, keyword) => `${binding} tiene un <code>${keyword['repeat']}</code> vacío`,
      ...
      HasRedundantReduction: (binding, must, target, keyword) => `${binding} usa <code>${keyword['is']}</code>, pero no realiza cálculos`,
      HasRedundantRepeat: (binding, must, target, keyword) => `${binding} tiene un <code>${keyword['repeat']}</code> innecesario`,
      ...
      HasUsageTypos_named: (binding, must, target, keyword) => `La solución parece tener un error de tipeo: debe usar ${target}, pero usa ${binding}. ¿Quizás quisiste decir ${target}?`,
      ...
      OverridesEqualOrHashButNotBoth: (binding, must, target, keyword) => `${binding} redefine los métodos <code>equals</code> o <code>hash</code>, pero no ambos`,
      ...
      ShouldInvertIfCondition: (binding, must, target, keyword) => `${binding} debería invertir la condición del <code>${keyword['if']}</code> e intercambiar las ramas`,
      SubordinatesDeclarationsTo: (binding, must, target, keyword) => `Todas las declaraciones en ${binding} ${must} ser usadas desde ${target}`,
      SubordinatesDeclarationsToEntryPoint: (binding, must, target, keyword) => `Todas las declaraciones en ${binding} ${must} deben ser usadas desde un <code>${keyword['entryPoint']}</code>`,
      ...
      UsesFail: (binding, must, target, keyword) => `${binding} usa <code>${keyword['fail']}</li>, lo cual es una mala práctica`,
      UsesFindall: (binding, must, target, keyword) => `${binding} ${must} utilizar <code>${keyword['findall']}</code>`,
      UsesForall: (binding, must, target, keyword) => `${binding} ${must} utilizar <code>${keyword['forall']}</code>`,
      UsesForeach: (binding, must, target, keyword) => `${binding} ${must} usar <code>${keyword['foreach']}</code>`,
      UsesForLoop: (binding, must, target, keyword) => `${binding} ${must} usar <code>${keyword['for']}</code>`,
      UsesGuards: (binding, must, target, keyword) => `${binding} ${must} usar guardas`,
      UsesIf: (binding, must, target, keyword) => `${binding} ${must} usar <code>${keyword['if']}</code>`,
      ...
      UsesNot: (binding, must, target, keyword) => `${binding} ${must} utilizar <code>${keyword['not']}</code>`,
      ...
      UsesRepeat: (binding, must, target, keyword) => `${binding} ${must} usar <code>${keyword['repeat']}</code>`,
      UsesRepeatOf: (binding, must, target, keyword) => `${binding} ${must} usar un <code>${keyword['repeat']}</code> de ${target}`,
      ...
      UsesSwitch: (binding, must, target, keyword) => `${binding} ${must} utilizar un <code>${keyword['switch']}</code>`,
      ...
      UsesWhile: (binding, must, target, keyword) => `${binding} ${must} utilizar un <code>${keyword['while']}</code>`,
      UsesYield: (binding, must, target, keyword) => `${binding} ${must} utilizar un <code>${keyword['yield']}</code>`
    },
    en: {
      must_not: 'must not',
      must: 'must',
      ...
      DeclaresFunction: (binding, must, target, keyword) => `${binding} ${must} declare functions`,
      ...
      DeclaresPredicate_named: (binding, must, target, keyword) => `${binding} ${must} declare a predicate ${target}`,
      ...
      DeclaresRecursively_named: (binding, must, target, keyword) => `${target} ${must} be declared recursively`,
      DeclaresRule_named: (binding, must, target, keyword) => `${binding} ${must} declare a rule ${target}`,
      DeclaresRule: (binding, must, target, keyword) => `${binding} ${must} declare rules`,
      ...
      DoesNilTest: (binding, must, target, keyword) => `${binding} does <code>${keyword['null']}</code> tests`,
      DoesNullTest: (binding, must, target, keyword) => `${binding} does <code>${keyword['null']}</code> tests`,
      DoesTypeTest: (binding, must, target, keyword) => `${binding} string type tests`,
      HasAssignmentCondition: (binding, must, target, keyword) => `${binding} evaluates the result of an assignment where a boolean expression is expected. Perhaps you meant to use the <code>${keyword['equal']}</code> operator?`,
      HasAssignmentReturn: (binding, must, target, keyword) => `${binding} returns the result of an assignment. Perhaps you meant to use the <code>${keyword['equal']}</code> operator?`,
      HasCodeDuplication: (binding, must, target, keyword) => `${binding} has code duplication`,
      HasDeclarationTypos_named: (binding, must, target, keyword) => `Solution must declare ${target}, but declares ${binding}. Perhaps you meant ${target}?`,
      HasEmptyIfBranches: (binding, must, target, keyword) => `${binding} has empty <code>${keyword['if']}</code> branches`,
      HasEmptyRepeat: (binding, must, target, keyword) => `${binding} has empty an <code>${keyword['repeat']}</code>`,
      ...
      HasRedundantBooleanComparison: (binding, must, target, keyword) => `${binding} makes unnecessary boolean comparisons`,
      HasRedundantGuards: (binding, must, target, keyword) => `${binding} has unnecessary guards`,
      HasRedundantIf: (binding, must, target, keyword) => `${binding} has unnecessary <code>${keyword['if']}</code>s`,
      HasRedundantLambda: (binding, must, target, keyword) => `${binding} has unnecessary lambdas`,
      HasRedundantLocalVariableReturn: (binding, must, target, keyword) => `${binding} has unnecessary local variables; please try returning the expression directly`,
      ...
      HasRedundantReduction: (binding, must, target, keyword) => `${binding} uses <code>${keyword['is']}</code>, but it does no arithmetics`,
      HasRedundantRepeat: (binding, must, target, keyword) => `${binding} has an unnecessary <code>${keyword['repeat']}</code>`,
      ...
      HasUsageTypos_named: (binding, must, target, keyword) => `Solution must use ${target}, but it uses ${binding}. Perhaps you meant ${target}?`,
      ...
      OverridesEqualOrHashButNotBoth: (binding, must, target, keyword) => `${binding} overrides <code>equals</code> or <code>hash</code> methods, but not both`,
      ...
      ReturnsNil: (binding, must, target, keyword) => `${binding} retuns <code>${keyword['null']}</code>, which is a bad practice`,
      ReturnsNull: (binding, must, target, keyword) => `${binding} retuns <code>${keyword['null']}</code>, which is a bad practice`,
      ShouldInvertIfCondition: (binding, must, target, keyword) => `${binding} should invert <code>${keyword['if']}</code> condition and swap branches`,
      SubordinatesDeclarationsTo: (binding, must, target, keyword) => `All declarations in ${binding} ${must} be used from ${target}`,
      SubordinatesDeclarationsToEntryPoint: (binding, must, target, keyword) => `All declarations in ${binding} ${must} be used from <code>${keyword['entryPoint']}</code>`,
      ...
      UsesAnonymousVariable: (binding, must, target, keyword) => `${binding} ${must} use an anonymous variable`,
      ...
      UsesCut: (binding, must, target, keyword) => `${binding} uses <code>!</li> operator, which is a bad practice`,
      ...
      UsesFail: (binding, must, target, keyword) => `${binding} uses <code>${keyword['fail']}</li>, which is a bad practice`,
      UsesFindall: (binding, must, target, keyword) => `${binding} ${must} use <code>${keyword['findall']}</code>`,
      UsesForall: (binding, must, target, keyword) => `${binding} ${must} use <code>${keyword['forall']}</code>`,
      UsesForeach: (binding, must, target, keyword) => `${binding} ${must} use <code>${keyword['foreach']}</code>`,
      UsesForLoop: (binding, must, target, keyword) => `${binding} ${must} use <code>${keyword['for']}</code>`,
      UsesGuards: (binding, must, target, keyword) => `${binding} ${must} use guards`,
      UsesIf: (binding, must, target, keyword) => `${binding} ${must} use <code>${keyword['if']}</code>`,
      UsesLambda: (binding, must, target, keyword) => `${binding} ${must} use lambda expressions`,
      UsesLogic: (binding, must, target, keyword) => `${binding} ${must} use boolean expressions`,
      UsesLoop: (binding, must, target, keyword) => `${binding} ${must} use a loop`,
      UsesMath: (binding, must, target, keyword) => `${binding} ${must} use math expressions`,
      ...
      UsesRepeat: (binding, must, target, keyword) => `${binding} ${must} use <code>${keyword['repeat']}</code>`,
      UsesRepeatOf: (binding, must, target, keyword) => `${binding} ${must} use <code>${keyword['repeat']}</code>`,
      ...
      UsesSwitch: (binding, must, target, keyword) => `${binding} ${must} use a <code>${keyword['switch']}</code>`,
      ...
      UsesWhile: (binding, must, target, keyword) => `${binding} ${must} use <code>${keyword['while']}</code>`
    },
    pt: {
      must_not: 'não deve',
      must: 'deve',
      ...
      DeclaresComputationWithArity0_named: (binding, must, target, keyword) => `${target} ${must} tem zero parâmetros`,
      ...
      DeclaresFunction: (binding, must, target, keyword) => `${binding} ${must} declarar funções`,
      ...
      DeclaresRecursively_named: (binding, must, target, keyword) => `${target} ${must} ser declarado recursivamente`,
      DeclaresRule_named: (binding, must, target, keyword) => `${binding} ${must} declarar uma regra ${target}`,
      DeclaresRule: (binding, must, target, keyword) => `${binding} ${must} declarar regras`,
      ...
      DoesNilTest: (binding, must, target, keyword) => `${binding}  faz comparações contra <code>${keyword['null']}</code>`,
      DoesNullTest: (binding, must, target, keyword) => `${binding}  faz comparações contra <code>${keyword['null']}</code>`,
      DoesTypeTest: (binding, must, target, keyword) => `${binding}  faz comparações contra strings`,
      HasAssignmentCondition: (binding, must, target, keyword) => `${binding} avalia o resultado de uma atribuição no qual uma expressão booleana era esperada. Talvez você queira usar o operador <code>${keyword['equal']}</code>?`,
      HasAssignmentReturn: (binding, must, target, keyword) => `${binding}  retorna o resultado de uma atribuição. Talvez você queira usar o operador <code>${keyword['equal']}</code>?`,
      HasCodeDuplication: (binding, must, target, keyword) => `${binding}  tem código repetido`,
      HasDeclarationTypos_named: (binding, must, target, keyword) => `A solução deve declarar ${target}, mas declarar ${binding}. Você poderia ter cometido um erro de digitação?`,
      HasEmptyIfBranches: (binding, must, target, keyword) => `${binding} tem vazio <code>${keyword['if']}</code> ramos`,
      HasEmptyRepeat: (binding, must, target, keyword) => `${binding} tem um <code>${keyword['repeat']}</code> vazio`,
      ...
      HasRedundantIf: (binding, must, target, keyword) => `${binding} <code>${keyword['if']}</code> desnecessário`,
      ...
      HasRedundantReduction: (binding, must, target, keyword) => `${binding}  usa <code>${keyword['is']}</code>, mas não executa cálculos`,
      HasRedundantRepeat: (binding, must, target, keyword) => `${binding} tem <code>${keyword['repeat']}</code> desnecessário`,
      ...
      HasUsageTypos_named: (binding, must, target, keyword) => `A solução deve usar ${target}, mas use ${binding}. Você poderia ter cometido um erro de digitação?`,
      ...
      OverridesEqualOrHashButNotBoth: (binding, must, target, keyword) => `${binding} redefine os métodos <code>equals</code> ou <code>hash </code>, mas não ambos`,
      ...
      ShouldInvertIfCondition: (binding, must, target, keyword) => `${binding} deve inverter a condição da <code>${keyword['if']}</code> e trocar as ramos`,
      SubordinatesDeclarationsTo: (binding, must, target, keyword) => `Todas as declarações em ${binding} ${must} ser usadas a partir de ${target}`,
      SubordinatesDeclarationsToEntryPoint: (binding, must, target, keyword) => `Todas as declarações em ${binding} ${must} devem ser usadas a partir de <code>${keyword['entryPoint']}</code>`,
      ...
      UsesFail: (binding, must, target, keyword) => `${binding}  usa <code>${keyword['fail']}</li>, o que é uma prática ruim`,
      UsesFindall: (binding, must, target, keyword) => `${binding} ${must} usar <code>${keyword['findall']}</code>`,
      UsesFor: (binding, must, target, keyword) => `${binding} ${must} usar <code>${keyword['for']}</code>`,
      UsesForall: (binding, must, target, keyword) => `${binding} ${must} usar <code>${keyword['forall']}</code>`,
      UsesForeach: (binding, must, target, keyword) => `${binding} ${must} usar <code>${keyword['foreach']}</code>`,
      UsesGuards: (binding, must, target, keyword) => `${binding} ${must} usar guardas`,
      UsesIf: (binding, must, target, keyword) => `${binding} ${must} usar <code>${keyword['if']}</code>`,
      ...
      UsesMixins: (binding, must, target, keyword) => `${binding} ${must} usar mixins`,
      UsesNot: (binding, must, target, keyword) => `${binding} ${must} usar <code>${keyword['not']}</code>`,
      ...
      UsesRepeat: (binding, must, target, keyword) => `${binding} ${must} usar <code>${keyword['repeat']}</code>`,
      UsesRepeatOf: (binding, must, target, keyword) => `${binding} ${must} usar uma <code>${keyword['repeat']}</code> de ${target}`,
      UsesStaticMethodOverload: (binding, must, target, keyword) => `${binding} ${must} usar sobrecarga`,
      UsesStaticPolymorphism: (binding, must, target, keyword) => `${binding} ${must} usar polimorfismo`,
      UsesSwitch: (binding, must, target, keyword) => `${binding} ${must} usar um <code>${keyword['switch']}</code>`,
      ...
      UsesWhile: (binding, must, target, keyword) => `${binding} ${must} usar um <code>${keyword['while']}</code>`,
    }
  };
