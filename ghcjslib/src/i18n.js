(() => {
  ...
  const LOCALES = {
    es: {
      ...
      HasAssignmentCondition: (binding, must, target, keyword) => `${binding} evalúa el resultado de una asignación en donde se esperaba una expresión booleana. ¿Quizás quisiste usar el operador <i>${keyword['equal']}</i>?`,
      HasAssignmentReturn: (binding, must, target, keyword) => `${binding} devuelve el resultado de una asignación. ¿Quizás quisiste usar el operador <i>${keyword['equal']}</i>?`,
      ...
      ShouldInvertIfCondition: (binding, must, target, keyword) => `${binding} debería invertir la condición del <i>${keyword['if']}</i> e intercambiar las ramas`,
      SubordinatesDeclarationsTo: (binding, must, target, keyword) => `Todas las declaraciones en ${binding} ${must} ser usadas desde ${target}`,
      SubordinatesDeclarationsToEntryPoint: (binding, must, target, keyword) => `Todas las declaraciones en ${binding} ${must} deben ser usadas desde un <i>${keyword['entryPoint']}</i>`,
    ...
    en: {
      ...
      DoesNullTest: (binding, must, target, keyword) => `${binding} does <i>${keyword['null']}</i> tests`,
      DoesTypeTest: (binding, must, target, keyword) => `${binding} string type tests`,
      HasAssignmentCondition: (binding, must, target, keyword) => `${binding} evaluates the result of an assignment where a boolean expression is expected. Perhaps you meant to use the <i>${keyword['equal']}</i> operator?`,
      HasAssignmentReturn: (binding, must, target, keyword) => `${binding} returns the result of an assignment. Perhaps you meant to use the <i>${keyword['equal']}</i> operator?`,
      ...
      HasRedundantIf: (binding, must, target, keyword) => `${binding} has unnecessary <i>${keyword['if']}</i>s`,
      ...
      HasRedundantReduction: (binding, must, target, keyword) => `${binding} uses <i>${keyword['is']}</i>, but it does no arithmetics`,
      HasRedundantRepeat: (binding, must, target, keyword) => `${binding} has an unnecessary <i>${keyword['repeat']}</i>`,
      ...
      ReturnsNil: (binding, must, target, keyword) => `${binding} retuns <i>${keyword['null']}</i>, which is a bad practice`,
      ReturnsNull: (binding, must, target, keyword) => `${binding} retuns <i>${keyword['null']}</i>, which is a bad practice`,
      ShouldInvertIfCondition: (binding, must, target, keyword) => `${binding} should invert <i>${keyword['if']}</i> condition and swap branches`,
      SubordinatesDeclarationsTo: (binding, must, target, keyword) => `All declarations in ${binding} ${must} be used from ${target}`,
      SubordinatesDeclarationsToEntryPoint: (binding, must, target, keyword) => `All declarations in ${binding} ${must} be used from <i>${keyword['entryPoint']}</i>`,
      ...
      UsesFail: (binding, must, target, keyword) => `${binding} uses <i>${keyword['fail']}</li>, which is a bad practice`,
      UsesFindall: (binding, must, target, keyword) => `${binding} ${must} use <i>${keyword['findall']}</i>`,
      UsesForall: (binding, must, target, keyword) => `${binding} ${must} use <i>${keyword['forall']}</i>`,
      UsesForeach: (binding, must, target, keyword) => `${binding} ${must} use <i>${keyword['foreach']}</i>`,
      UsesForLoop: (binding, must, target, keyword) => `${binding} ${must} use <i>${keyword['for']}</i>`,
      UsesGuards: (binding, must, target, keyword) => `${binding} ${must} use guards`,
      UsesIf: (binding, must, target, keyword) => `${binding} ${must} use <i>${keyword['if']}</i>`,
      ...
      UsesRepeat: (binding, must, target, keyword) => `${binding} ${must} use <i>${keyword['repeat']}</i>`,
      UsesRepeatOf: (binding, must, target, keyword) => `${binding} ${must} use <i>${keyword['repeat']}</i>`,
      ...
      UsesSwitch: (binding, must, target, keyword) => `${binding} ${must} use a <i>${keyword['switch']}</i>`,
      ...
      UsesWhile: (binding, must, target, keyword) => `${binding} ${must} use <i>${keyword['while']}</i>`
    },
    pt: {
      must_not: 'não deve',
      must: 'deve',
      ...
      DoesNullTest: (binding, must, target, keyword) => `${binding}  faz comparações contra <i>${keyword['null']}</i>`,
      DoesTypeTest: (binding, must, target, keyword) => `${binding}  faz comparações contra strings`,
      HasAssignmentCondition: (binding, must, target, keyword) => `${binding} avalia o resultado de uma atribuição no qual uma expressão booleana era esperada. Talvez você queira usar o operador <i>${keyword['equal']}</i>?`,
      HasAssignmentReturn: (binding, must, target, keyword) => `${binding}  retorna o resultado de uma atribuição. Talvez você queira usar o operador <i>${keyword['equal']}</i>?`,
      ...
      HasRedundantIf: (binding, must, target, keyword) => `${binding} <i>${keyword['if']}</i> desnecessário`,
      ...
      HasRedundantReduction: (binding, must, target, keyword) => `${binding}  usa <i>${keyword['is']}</i>, mas não executa cálculos`,
      HasRedundantRepeat: (binding, must, target, keyword) => `${binding} tem <i>${keyword['repeat']}</i> desnecessário`,
      ...
      ShouldInvertIfCondition: (binding, must, target, keyword) => `${binding} deve inverter a condição da <i>${keyword['if']}</i> e trocar as ramos`,
      ...
      SubordinatesDeclarationsToEntryPoint: (binding, must, target, keyword) => `Todas as declarações em ${binding} ${must} devem ser usadas a partir de <i>${keyword['entryPoint']}</i>`,
      ...
      UsesFail: (binding, must, target, keyword) => `${binding}  usa <i>${keyword['fail']}</li>, o que é uma prática ruim`,
      UsesFindall: (binding, must, target, keyword) => `${binding} ${must} usar <i>${keyword['findall']}</i>`,
      UsesFor: (binding, must, target, keyword) => `${binding} ${must} usar <i>${keyword['for']}</i>`,
      UsesForall: (binding, must, target, keyword) => `${binding} ${must} usar <i>${keyword['forall']}</i>`,
      UsesForeach: (binding, must, target, keyword) => `${binding} ${must} usar <i>${keyword['foreach']}</i>`,
      UsesGuards: (binding, must, target, keyword) => `${binding} ${must} usar guardas`,
      UsesIf: (binding, must, target, keyword) => `${binding} ${must} usar <i>${keyword['if']}</i>`,
      ...
      UsesMixins: (binding, must, target, keyword) => `${binding} ${must} usar mixins`,
      UsesNot: (binding, must, target, keyword) => `${binding} ${must} usar <i>${keyword['not']}</i>`,
      ...
      UsesRepeat: (binding, must, target, keyword) => `${binding} ${must} usar <i>${keyword['repeat']}</i>`,
      UsesRepeatOf: (binding, must, target, keyword) => `${binding} ${must} usar uma <i>${keyword['repeat']}</i> de ${target}`,
      UsesStaticMethodOverload: (binding, must, target, keyword) => `${binding} ${must} usar sobrecarga`,
      UsesStaticPolymorphism: (binding, must, target, keyword) => `${binding} ${must} usar polimorfismo`,
      UsesSwitch: (binding, must, target, keyword) => `${binding} ${must} usar um <i>${keyword['switch']}</i>`,
      ...
      UsesWhile: (binding, must, target, keyword) => `${binding} ${must} usar um <i>${keyword['while']}</i>`,
    }
  };
